...
#Fonction convertissant les .json generer ecrire_json() par  en .xml
def ecrire_xml():
...
#Creer une speudo base de donnees en .json
	...
	try:
		with open("fichier.json", "r") as fichier:
			...
			if len(liste_posts) > 19:
				del liste_posts[0]
	#Si le .json n'existe, un nouveau est cree
	except:
...
class MyStreamer(TwythonStreamer):
	def on_success(self, data):
		if 'text' in data:
			...
			#verification de la presence une image ou une video joint au tweet
