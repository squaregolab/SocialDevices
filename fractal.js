...
function canvasApp(couleur1,couleur2) {
	if (!canvasSupport()) {
		return;
	}
	...
	init(couleur1,couleur2);
	
	function init(couleur1,couleur2) {
		/*
		...
		*/
		...
		startGenerate(couleur1,couleur2);
	}
	
	function startGenerate(couleur1,couleur2) {
		drawCount = 0;
		context.setTransform(1,0,0,1,0,0);
		
		context.clearRect(0,0,displayWidth,displayHeight);
		
		setCircles(couleur1,couleur2);
		
		if(timer) {clearInterval(timer);}
		timer = setInterval(onTimer,1000/500);
	}
	
	function setCircles(couleur1,couleur2) {
		var i;
		var r,g,b,a;
		var maxR, minR;
		var grad;
